        ...
        <div className="row">
          <div className="col-lg-4 col-md-6 col-12 text-white">
            ...
            <div className="mb-4">
              ...
              <div className="mt-4">
                <p>
                CrispTV Academy: Empowering young Nigerians with industry-relevant media skills for careers and entrepreneurship. Join us to transform your future and become a leader in the booming media industry                </p>
                {/* social media */}
          ...
          <div className="offset-lg-1 col-lg-2 col-md-3 col-6">
            <div className="mb-4">
              {/* list */}
              <h3 className="fw-bold mb-3">Join CrispTV Now</h3>
          ...
          <div className="col-lg-3 col-md-12">
            ...
            <div className="mb-4">
              ...
              <p>9b Nza Street,Independence Layout, Enugu State</p>
              <p className="mb-1">
                Email:
                <a href="#" className='text-white'> support@crisptv.academy</a>
              </p>
              <p>
                Phone:+2348063311751
