          ...
          <div className="row align-items-center bg-primary gx-0 rounded-3 mt-5">
            ...
            <div className="col-lg-5 col-12">
              <div className="text-white p-5 p-lg-0">
                {/* text */}
                <h2 className="h1 text-white">@CrispTV</h2>
                <p className="mb-0">
                Empowering young people with industry-relevant media skills for careers and entrepreneurship. Join us to transform your future and become a leader in the booming media industry
                </p>
                <a href="#" className="btn bg-white text-dark fw-bold mt-4">
                  Start Learning Today <i className="fas fa-arrow-right"></i>
                </a>
              </div>
            </div>
          </div>
